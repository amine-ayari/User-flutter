  ...
  void initState() {
    ...
    if (_isBlocked) {
      WidgetsBinding.instance?.addPostFrameCallback((_) {
        showBlockedSnackbar(context); // Show the snackbar if profile is blocked
      });
    }
  }
  ...
  Widget buildBlockButton() {
    return ElevatedButton(
      onPressed: () async {
        ...
        showBlockedSnackbar(context); // Show snackbar after blocking profile
      },
  ...
  Widget buildUnblockButton() {
    return ElevatedButton(
      onPressed: () async {
        ...
        showUnblockedSnackbar(context); // Show snackbar after unblocking profile
      },
              ...
              child: Column(
                ...
                children: [
                  ...
                  _isBlocked
                      ? Builder(
                          builder: (context) {
                            return buildUnblockButton(); // Show unblock button if profile is blocked
                          },
                        )
                      : buildBlockButton(),
                ],
